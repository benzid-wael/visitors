...
int vi_parse_line(struct logline *ll, char *l)
{
	...
	*p = '\0';
	ll->time = parse_date(date, &ll->tm, Config_time_delta);
...
int qsort_cmp_dates_generic(const void *a, const void *b, int off, int mul)
{
	...
	ta = parse_date(dateA, NULL, Config_time_delta);
	tb = parse_date(dateB, NULL, Config_time_delta);
...
enum {
	...
	OPT_PREFIX,
	OPT_TRAILS,
	OPT_GOOGLEKEYPHRASES,
	OPT_GOOGLEKEYPHRASESAGE,
	OPT_MAXGOOGLEKEYPHRASES,
	OPT_MAXGOOGLEKEYPHRASESAGE,
	OPT_MAXTRAILS,
	OPT_GRAPHVIZ,
	OPT_WEEKDAYHOUR_MAP,
	OPT_MONTHDAY_MAP,
	...
	OPT_ROBOTS,
	OPT_MAXROBOTS,
	OPT_GRAPHVIZ_ignorenode_GOOGLE,
	OPT_GRAPHVIZ_ignorenode_EXTERNAL,
	OPT_GRAPHVIZ_ignorenode_NOREFERER,
	OPT_GOOGLEHUMANLANGUAGE,
	OPT_FILTERSPAM,
	OPT_MAXADSENSED,
	OPT_GREP,
	OPT_EXCLUDE,
